...
const passwordcopytoclip= useCallback(()=>{
  ...
  // passwordRef.current?.setSelectionRange(0,5)   ye range me select krta ha is property se
...
useEffect(()=>{
  ...
  return (
    <>
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-6 my-8
...
className='bg-blue-700 text-white px-3 py-0.5 shrink-0 hover:bg-black '>Copy</button>
</div>
